...
function generateSelector(config) {
  ...
  function Select(props, ref) {
    ...
    var tokenWithEnter = (0, _react.useMemo)(function () {
    ...
    var mergedShowSearch = showSearch !== undefined ? showSearch : isMultiple || mode === 'combobox';
    // ============================== Ref ===============================
    var selectorDomRef = (0, _react.useRef)(null);
    ...
    /** Unique raw values */
    var mergedRawValue = (0, _react.useMemo)(function () {
    ...
    var rawValues = (0, _react.useMemo)(function () {
    ...
    var mergedFlattenOptions = (0, _react.useMemo)(function () {
      return flattenOptions(mergedOptions, props);
    }, [mergedOptions]);
    var getValueOption = (0, _useCacheOptions.default)(mergedRawValue, mergedFlattenOptions);
    ...
    var displayFlattenOptions = (0, _react.useMemo)(function () {
    ...
    var displayValues = (0, _react.useMemo)(function () {
      var tmpValues = mergedRawValue.map(function (val) {
        ...
        return (0, _objectSpread2.default)((0, _objectSpread2.default)({}, displayValue), {}, {
    ...
    var triggerChange = function triggerChange(newRawValues) {
      ...
      if (onChange && (mergedRawValue.length !== 0 || outValues.length !== 0)) {
        ...
        setPrevValueOptions(outOptions.map(function (option, index) {
          var clone = (0, _objectSpread2.default)({}, option);
    ...
    var onInternalOptionSelect = function onInternalOptionSelect(newValue, info) {
      onInternalSelect(newValue, (0, _objectSpread2.default)((0, _objectSpread2.default)({}, info), {}, {
        source: 'option'
      }));
    };
    ...
    (0, _useSelectTriggerControl.default)([containerRef.current, triggerRef.current && triggerRef.current.getPopupElement()], triggerOpen, onToggleOpen);
    // ============================= Search =============================
    ...
    var onInternalMouseDown = function onInternalMouseDown(event) {
      ...
      var popupElement = triggerRef.current && triggerRef.current.getPopupElement();
    ...
    // ============================= Render =============================
    var mergedClassName = (0, _classnames.default)(prefixCls, className, (0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)({}, "".concat(prefixCls, "-focused"), mockFocused), "".concat(prefixCls, "-multiple"), isMultiple), "".concat(prefixCls, "-single"), !isMultiple), "".concat(prefixCls, "-allow-clear"), allowClear), "".concat(prefixCls, "-show-arrow"), mergedShowArrow), "".concat(prefixCls, "-disabled"), disabled), "".concat(prefixCls, "-loading"), loading), "".concat(prefixCls, "-open"), mergedOpen), "".concat(prefixCls, "-customize-input"), customizeInputElement), "".concat(prefixCls, "-show-search"), mergedShowSearch));
    return /*#__PURE__*/React.createElement("div", Object.assign({
      ...
      "aria-live": "polite"
    }, "".concat(mergedRawValue.join(', ')))), /*#__PURE__*/React.createElement(_SelectTrigger.default, {
      ref: triggerRef,
      disabled: disabled,
      prefixCls: prefixCls,
      visible: triggerOpen,
    ...
    }, /*#__PURE__*/React.createElement(_Selector.default, Object.assign({}, props, {
